...
class internet_shop:
    ...
    def post(self):
        self._driver.find_element
        (By.CSS_SELECTOR, "#first-name").send_keys("Andrey")
...
magazine_swag_labs = internet_shop(driver=driver)
url = (
    "https://www.ssaucedemo.com/cart.html")
