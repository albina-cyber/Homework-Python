...
magazine_swag_labs = internet_shop(driver=driver, url="https://www.saucedemo.com/")
magazine_swag_labs.username("standard_user")
magazine_swag_labs.password("secret_sauce")
magazine_swag_labs.button("#login-button")

magazine_swag_labs = internet_shop(driver=driver, url="https://www.saucedemo.com/inventory.html")
...
magazine_swag_labs = internet_shop(driver=driver, url="https://www.saucedemo.com/cart.html")
magazine_swag_labs.button("#shopping_cart_container")
magazine_swag_labs.button("#checkout")

magazine_swag_labs = internet_shop(driver=driver, url="https://www.saucedemo.com/checkout-step-one.html")
magazine_swag_labs.post()
magazine_swag_labs.button("#continue")

magazine_swag_labs = internet_shop(driver=driver, url="https://www.saucedemo.com/checkout-step-two.html")
